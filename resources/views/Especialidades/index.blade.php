...
<h1 align="center">Listado de especialidades</h1>
<br />
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="especialidades/create" class="btn btn-primary btn-block">Crear una nueva especialidad</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/especialidades/'.$especialidad->id]) !!}
                    <a href="{!! 'especialidades/'.$especialidad->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'especialidades/'.$especialidad->id.'/edit' !!}" class="btn btn-warning">
