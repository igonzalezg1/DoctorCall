...
<h1 align="center">Crear una nueva Especialidad.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/especialidades', 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre de la especialidad',['class'=>'text-muted miest']) !!}
        {!! Form::text ('nombre',null,['placeholder'=>'Ingresa el nombre de la especialidad', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
