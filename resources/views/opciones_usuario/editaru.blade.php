...
<h1 align="center">Editar Usuario {!! $user->nombres !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['method'=>'PATCH', 'url'=>'/opcionesusuario/'.$user->id, 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('ap_paterno', 'Apellido paterno del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('ap_paterno',$user->ap_paterno,['placeholder'=>'Ingresa el nombre', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('ap_materno', 'Apellido materno del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('ap_materno',$user->ap_materno,['placeholder'=>'Ingresa el nombre', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('nombres', 'Nombre(s) del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('nombres',$user->nombres,['placeholder'=>'Ingresa el nombre(s)', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('edad', 'Edad del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::number ('edad',$user->edad,['placeholder'=>'Ingresa la edad', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('telefono', 'Telefono del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::number ('telefono',$user->telefono,['placeholder'=>'Ingresa el telefono', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('fecha_nacimiento', 'Fecha de nacimiento del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::date ('fecha_nacimiento',$user->fecha_nacimiento,['placeholder'=>'Ingresa la fecha de nacimiento', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('email', 'Correo del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::email ('email',$user->email,['placeholder'=>'Ingresa el correo', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('direccion', 'Direccion del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('direccion',$user->direccion,['placeholder'=>'Ingresa la direccion', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('cp', 'Codigo postal del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::number ('cp',$user->cp,['placeholder'=>'Ingresa el codigo postal', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('username', 'Username del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('username',$user->username,['placeholder'=>'Ingresa el Username', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_pais',$paises->pluck('nombre','id')->all(), $user->id_pais, ['placeholder'=>'Seleccionar', 'class'=>'form-control', 'onchange'=>'llenar_entidades(this.value);']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
        ...
        <br />
        {!! Form::select ('id_entidad',array(''=>'seleccionar...'), $user->id_entidad, ['placeholder'=>'Seleccionar', 'class'=>'form-control', 'onchange'=>'llenar_municipios(this.value);']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
        ...
        <br />
        {!! Form::select ('id_municipio',array(''=>'seleccionar...'), $user->id_municipio, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        {!! Form::label ('status', 'Estatus del usuario',['class'=>'text-muted miest']) !!}
        {!! Form::select ('status', array('1'=>'Activo', '0'=>'Inactivo','2'=>'pendiente'), $user->status, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::submit ('Guardar cambios',['class'=>'btn btn-outline-success btn-block']) !!}
    </div>
{!! Form::close() !!}
    </div>
</div>
