...
<h1 align="center">Crear un detalle de cita.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/detalles_citas', 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('fecha', 'Fecha de cita',['class'=>'text-muted miest']) !!}
        {!! Form::date ('fecha',null,['placeholder'=>'Ingresa la fecha','class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('hora', 'Hora de cita',['class'=>'text-muted miest']) !!}
        {!! Form::time ('hora',null,['placeholder'=>'Ingresa la hora','class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('subtotal', 'Subtotal',['class'=>'text-muted miest']) !!}
        {!! Form::number ('subtotal',null,['placeholder'=>'Ingresa el subtotal', 'class'=>'form-control', 'step'=>'any']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('iva', 'IVA',['class'=>'text-muted miest']) !!}
        {!! Form::number ('iva',null,['placeholder'=>'Ingresa el IVA', 'class'=>'form-control', 'step'=>'any']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('total', 'Total',['class'=>'text-muted miest']) !!}
        {!! Form::number ('total',null,['placeholder'=>'Ingresa el total', 'class'=>'form-control', 'step'=>'any']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('no_tarjeta', 'Numero de tarjeta',['class'=>'text-muted miest']) !!}
        {!! Form::number ('no_tarjeta',null,['placeholder'=>'Ingresa el numero de tarjeta', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('cvv', 'Numero CVV',['class'=>'text-muted miest']) !!}
        {!! Form::number ('cvv',null,['placeholder'=>'Ingresa el numero CVV', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        <br />
        {!! Form::label ('id_cita', 'Numero de cita',['class'=>'text-muted miest']) !!}
        <br />
        {!! Form::select ('id_cita',$citas->pluck('id','id')->all(), null, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
