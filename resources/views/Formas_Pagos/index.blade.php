...
<h1 align="center">Listado de formas de pago</h1>
<br />
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="formas_pagos/create" class="btn btn-primary btn-block">Crear una nueva forma de pago</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/formas_pagos/'.$formapago->id]) !!}
                    <a href="{!! 'formas_pagos/'.$formapago->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'formas_pagos/'.$formapago->id.'/edit' !!}" class="btn btn-warning">
