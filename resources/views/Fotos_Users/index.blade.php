...
<h1 align="center">Listado de fotos de usuarios</h1>
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="fotos_users/create" class="btn btn-primary btn-block">Crear una nueva foto de usuario</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tbody>
                @foreach($fotosusers as $fotouser)
                <tr>
                    <td>{!! $fotouser->id !!}</td>
                    <td>{!! $fotouser->users->nombres !!}</td>
                    <td>{!! $fotouser->ruta !!}</td>
                    <td><img src="{{ asset('../storage/productos') }}/{!! $fotouser->ruta !!}" alt="" width="150px"></td>
                    <td>
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/fotos_users/'.$fotouser->id]) !!}
                    <a href="{!! 'fotos_users/'.$fotouser->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'fotos_users/'.$fotouser->id.'/edit' !!}" class="btn btn-warning">
