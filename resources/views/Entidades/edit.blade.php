...
<div class="row">
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_pais',$paises->pluck('nombre','clave')->all(), $entidad->id_pais, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
        ...
        <br />
        {!! Form::select ('status', array('1'=>'Activo', '0'=>'Inactivo'), $entidad->status, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
