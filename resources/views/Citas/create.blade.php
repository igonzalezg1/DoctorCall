...
<h1 align="center">Crear una cita.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['url'=>'/citas', 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        <br />
        {!! Form::label ('tipo_cita', 'Tipo de cita',['class'=>'text-muted miest']) !!}
        <br />
        {!! Form::select ('tipo_cita', array('presencial'=>'Presencial en consultorio', 'en linea'=>'En linea (videollamada)', 'domicilio'=>'Cita a domicilio'), null, ['placeholder'=>'Seleccionar','class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_cliente',$clientes->pluck('nombres','id')->all(), null, ['placeholder'=>'Seleccionar','class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
        ...
        <br />
        {!! Form::select ('id_forma_pago',$formaspagos->pluck('nombre','id')->all(), null, ['placeholder'=>'Seleccionar','class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
