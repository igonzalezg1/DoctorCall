...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="citas/create" class="btn btn-primary btn-block">Crear una nueva cita</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tr>
                    ...
                    <a href="{!! 'citas/'.$cita->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'citas/'.$cita->id.'/edit' !!}" class="btn btn-warning">
