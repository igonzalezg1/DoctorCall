...
<h1 align="center">EditarUsuario {!! $user->nombres !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('id_tipo_usuario',$tiposusers->pluck('nombre','id')->all(), $user->id_tipo_usuario, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
