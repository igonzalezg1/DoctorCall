...
<h1 align="center">Editar consultorio {!! $consultorio->nombre !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['method'=>'PATCH', 'url'=>'/consultorios/'.$consultorio->id, 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre del consultorio',['class'=>'text-muted miest']) !!}
        {!! Form::text ('nombre',$consultorio->nombre,['placeholder'=>'Ingresa el nombre del consultorio', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('direccion', 'Direccion del consultorio',['class'=>'text-muted miest']) !!}
        {!! Form::text ('direccion',$consultorio->direccion,['placeholder'=>'Ingresa la direccion del consultorio', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('cp', 'Codigo postal del consultorio',['class'=>'text-muted miest']) !!}
        {!! Form::number ('cp',$consultorio->cp,['placeholder'=>'Ingresa el codigo postal del consultorio', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('telefono', 'Telefono del consultorio',['class'=>'text-muted miest']) !!}
        {!! Form::number ('telefono',$consultorio->telefono,['placeholder'=>'Ingresa el telefono del consultorio', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <br />
        {!! Form::select ('status', array('1'=>'Activo', '0'=>'Inactivo'), $consultorio->stauts, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
