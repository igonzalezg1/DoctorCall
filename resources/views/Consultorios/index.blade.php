...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="consultorios/create" class="btn btn-primary btn-block">Crear un nuevo consultorio</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tr>
                    ...
                    <td>{!! $consultorio->municipios->nombre !!}</td>
                    <td>
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/consultorios/'.$consultorio->id]) !!}
                    <a href="{!! 'consultorios/'.$consultorio->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'consultorios/'.$consultorio->id.'/edit' !!}" class="btn btn-warning">
