...
<h1 align="center">Editar {!! $tipouser->nombre !!}.</h1>
<br />
<div class="container">
<div class="row">
    <div class="col-sm-12">
    {!! Form::open(['method'=>'PATCH', 'url'=>'/tipos_users/'.$tipouser->id, 'onsubmit'=>'return validar();']) !!}
    <div class="form-group">
        {!! Form::label ('nombre', 'Nombre del tipo de usuario',['class'=>'text-muted miest']) !!}
        {!! Form::text ('nombre',$tipouser->nombre,['placeholder'=>'Ingresa el nombre', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('rango', 'Rango del tipo de usuario',['class'=>'text-muted miest']) !!}
        {!! Form::number ('rango',$tipouser->rango,['placeholder'=>'Ingresa el rango', 'class'=>'form-control']) !!}
    </div>
    <div class="form-group">
        {!! Form::label ('status', 'Estatus del tipo de usuario',['class'=>'text-muted miest']) !!}
        <br />
        {!! Form::select ('status', array('1'=>'Activo', '0'=>'Inactivo'), $tipouser->status, ['placeholder'=>'Seleccionar', 'class'=>'form-control']) !!}
        <br />
    </div>
    <div class="form-group">
        <br />
