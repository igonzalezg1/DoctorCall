...
<h1 align="center">Listado de tipos de usuario</h1>
<br />
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <a href="tipos_users/create" class="btn btn-primary btn-block">Crear un nuevo tipo de usuario</a>
        </div>
    </div>
    <br />
    <div class="row">
        <div class="col-sm-12">
            <table id="tabla1" class="display" style="width:100%">
                ...
                <tbody>
                @foreach($tiposusers as $tipouser)
                <tr>
                    <td>{!! $tipouser->id !!}</td>
                    <td>{!! $tipouser->nombre !!}</td>
                    <td>{!! $tipouser->rango !!}</td>
                    <td>
                    {!! Form::open(['method'=>'DELETE' , 'url'=>'/tipos_users/'.$tipouser->id]) !!}
                    <a href="{!! 'tipos_users/'.$tipouser->id !!}" class="btn btn-success">
                    ...
                    <a href="{!! 'tipos_users/'.$tipouser->id.'/edit' !!}" class="btn btn-warning">
